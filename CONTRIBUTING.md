...
**0.**  Take a look at the existing [issues](https://github.com/Azeemahma) or create your own issues. Wait for the Issue to be assigned to you after which you can start working on it.
